...
export default function PaymentPage({
  ...
  useEffect(() => {
    ...
    pollRef.current = setInterval(async () => {
      try {
        const result = await onCheckPayment(resId);
  ...
  const isSuccess = (paymentStatus?.type === 'success' && resStatus !== 'partial') || resStatus === 'paid' || resStatus === 'settlement';
